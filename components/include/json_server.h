...
#define CONTENT_THREAD_MSG_BUFF_LEN 512
...
extern char newaction_mess_json[];
...
typedef struct __attribute__((packed)) JSMN_JSON_CONTENT_MESSAGE_tst tag
{
    uint16_t content;
} JSMN_JSON_CONTENT_MESSAGE_tst;
extern JSMN_JSON_CONTENT_MESSAGE_tst JSMN_JSON_CONTENT_MESSAGE_st obj;
...
extern uint8_t json_content_thread_msg_buff_gau8[CONTENT_THREAD_MSG_BUFF_LEN];
...
extern uint8_t json_pack_content_message(JSMN_JSON_CONTENT_MESSAGE_tst *content_mess_pst);
